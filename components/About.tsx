                ...
                <div className="flex-1 text-left mx-4 mt-4 md:mt-0 md:mx-0 md:p-6">
                    <div className="flex flex-col gap-2.5">
                        ...
                        <div className="flex items-center gap-4 md:mt-4">
                            {resumeUrl.trim() && <a href={resumeUrl} download="Resume" className="text-sm md:text-base bg-violet-600 dark:bg-violet-700 text-white w-fit rounded-md py-2 px-6 hover:shadow-xl transition-shadow cursor-pointer">Download Resume</a>}
